...
<br>
    <form method="POST" action="{{route('pembayaran.update', $pembayaran['id'])}}" class="forms-sample" enctype="multipart/form-data">
      ...
      <div class="form-group">
          ...
          <input type="text" class="block w-full mt-1 text-sm focus:border-purple-400 focus:outline-none focus:shadow-outline-purple form-input" id="metode" name="metode" value="{{old('metode') ? old('metode'): $pembayaran['metode'] }}"
              placeholder="metode">
          @error('metode')
